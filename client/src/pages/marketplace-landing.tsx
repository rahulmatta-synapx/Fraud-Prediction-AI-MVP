            ...
            <div className="space-y-4">
              ...
              <div className="bg-emerald-50 dark:bg-emerald-900/30 rounded-lg p-4 space-y-2 text-left">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-slate-800 dark:text-slate-200">{org.org_name}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-slate-600 dark:text-slate-400">Plan</span>
                  <span className="font-medium text-emerald-600 uppercase">{org.subscription_tier}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-slate-600 dark:text-slate-400">Status</span>
                  <span className="font-medium text-emerald-600 capitalize">{org.subscription_status}</span>
                </div>
              </div>
              <p className="text-sm text-slate-500 dark:text-slate-400">
          ...
          {state === "error" && (
            <div className="space-y-4">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">
                ...
                <a href="mailto:support@synapx.ai" className="text-emerald-600 underline">
                  support@synapx.ai
                </a>{" "}
